...
const socialDescription = html.match(/property="og:description"\s+content="([^"]+)"/)?.[1];
assert.ok(description?.length > 40, 'descriptive search preview');
assert.equal(socialDescription, description, 'consistent Open Graph description');
